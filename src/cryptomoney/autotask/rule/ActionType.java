...
public enum ActionType
{
    ...
    ALLOWANCE_WITHDRAW_COIN_TO_COINBASE_BELOW_MINIMUM_DESTINATION_BALANCE,
    ALLOWANCE_WITHDRAW_COIN_TO_CRYPTO,
    ALLOWANCE_DEPOSIT_FIAT,
    
    ACTION_BUY_COIN_DCA_POSTONLY,
    ACTION_WITHDRAW_COIN_TO_COINBASE,
    ACTION_WITHDRAW_COIN_TO_COINBASE_BELOW_MINIMUM_DESTINATION_BALANCE,
    ACTION_WITHDRAW_COIN_TO_CRYPTO,
    ACTION_DEPOSIT_FIAT,
